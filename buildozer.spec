...
title = (Name of your Kivy App, No quotes)

# (str) Package name
package.name = (Organization name, No quotes)

# (str) Package domain (needed for android/ios packaging)
package.domain = com.(your domain, No quotes)
...
# comma separated e.g. requirements = sqlite3, kivy (add extras depending on your imports)
...
presplash.filename = %(source.dir)s/images/(your presplash filename)

# (str) Icon of the application
icon.filename = %(source.dir)s/images/(your image filename)
